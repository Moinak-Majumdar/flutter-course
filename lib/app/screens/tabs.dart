...
class _TabNavigationState extends ConsumerState<TabNavigation> {
  ...
  Widget build(context) {
    ...
    if (_selectedScreenIndex == 1) {
      //hl2 favorite without filters.
      // final favoriteMeals = ref.watch(favoriteProvider);
      //hl3 favorite meals with active filters.
      final filterFavoriteMeals = ref.watch(filterFavoriteMealsProvider);
      activePageTitle = 'Favorites';
      activePage = MealsScreen(
        meals: filterFavoriteMeals,
      );
    }
